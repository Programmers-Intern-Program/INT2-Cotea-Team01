...
public class QuestionResolver {
    ...
    private static final Map<String, String> BUTTON_QUESTIONS = Map.of(
            "hint_level_1", "이 문제를 어떤 관점에서 바라봐야 할지 모르겠어요",
            "hint_level_2", "어떤 알고리즘으로 접근해야 할지 모르겠어요",
            "hint_level_3", "구현 순서가 잘 안 잡혀요",
            "hint_level_4", "제 코드에서 문제가 있는지 봐주세요"
    );
